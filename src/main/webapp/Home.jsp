			...
			<div
				...
				<div class="filter p-4">
					<form action="CardInmuebleServlet?type=search" class="search-filter d-flex justify-content-center">
						...
						<input type="text" placeholder="Precio Mín"
							class="form-control mx-2" name="min"> 
					    <input type="text"
							placeholder="Precio Máx" class="form-control mx-2" name="max"> 
			...
			<div class="row">
				<div class="col-md-4 text-center">
					...
					<p>Somos una empresa dedicada a ofrecer las mejores propiedades
						y departamentos, brindando confianza, calidad y atención
						personalizada.</p>
				</div>
				<div class="info col-md-4 text-center">
					<h3>Contacto</h3>
					<p>
						<img src="./images/phone.png" class="footer-icon" alt="Teléfono">+51
						987 654 321
					</p>
					<p>
